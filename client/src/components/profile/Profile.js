...
function Profile() {
    ...
    const handleUpdeteProfile = async () => {
        store.dispatch(setLoading(true))
        await navigate('/updateProfile')
                    ...
                    <div className="profile-card">
                        ...
                        {!isMyProfile &&
                            <h5 onClick={handleUserFollow}
                                className={isFollowing ? "hover-link follow-link follow" : "btn-primary follow"} >
                                {
